...
public class WallpaperManager {
    ...
    /**
     * B站风格使用纯色背景，全局壁纸默认关闭。
     * 需要恢复壁纸功能时调用 setWallpaperEnabled(true)。
     */
    private static boolean sWallpaperEnabled = false;

    public static void setWallpaperEnabled(boolean enabled) {
        sWallpaperEnabled = enabled;
    }

    public static boolean isWallpaperEnabled() {
        return sWallpaperEnabled;
    }
